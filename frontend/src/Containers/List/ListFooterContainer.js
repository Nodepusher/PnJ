    ...
    return (
        <div class="mt-[56px] mobile:mt-[128px]">
            <footer class="surface_secondary sticky top-[100vh] mt-[48px] w-full mobile:mt-[80px]">
                <div class="mx-auto max-w-desktop-grid">
                    <div class="hidden lg:block">
                        <div class="pt-[40px] pb-[45px]">
                            <div class="border_primary flex justify-between border-b pb-[28px]">
                                <svg
                                    viewBox="0 0 115 16"
                                    xmlns="http://www.w3.org/2000/svg"
                                    class="content_secondary h-[18px] w-[128px]"
                                >
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
                                ...
                                <div class="flex gap-x-[52px]">
                                    <div class="content_secondary flex flex-col">
                                        <h5 class="font_label_bold_xl mb-[8px]">스테디오</h5>
                                        <a class="false font_label_regular_lg mt-[8px]" target="_blank" href="/start">
                                            크리에이터 시작
                                        </a>
                                        <a class="false font_label_regular_lg mt-[8px]" target="_blank" href="/plans">
                                            요금제
                                        </a>
                                        <a
                                            class="false font_label_regular_lg mt-[8px]"
                                            target="_blank"
                                    ...
                                    <div class="content_secondary flex flex-col">
                                        <h5 class="font_label_bold_xl mb-[8px]">이용안내</h5>
                                        <a
                                            class="false font_label_regular_lg mt-[8px]"
                                            target="_blank"
                                    ...
                                    <div class="content_secondary flex flex-col">
                                        <h5 class="font_label_bold_xl mb-[8px]">정책</h5>
                                        <a
                                            class="false font_label_regular_lg mt-[8px]"
                                            target="_blank"
                                        ...
                                        <a
                                            class="font-bold font_label_regular_lg mt-[8px]"
                                            target="_blank"
                                    ...
                                    <div class="content_secondary flex flex-col">
                                        <h5 class="font_label_bold_xl mb-[8px]">고객지원</h5>
                                        <p class="font_label_regular_lg mt-[8px]">
                            ...
                            <div class="content_quaternary mt-[20px]">
                                <p>
                                    <span class="font_label_bold_md ml-[12px] first:m-0">회사명</span>
                                    <span class="font_label_regular_md ml-[8px]">주식회사 백패커</span>
                                    <span class="font_label_bold_md ml-[12px] first:m-0">주소</span>
                                    <span class="font_label_regular_md ml-[8px]">
                                        주소 서울특별시 서초구 서초대로 398, 20층(서초동, BNK디지털타워)
                                    </span>
                                    <span class="font_label_bold_md ml-[12px] first:m-0">대표</span>
                                    <span class="font_label_regular_md ml-[8px]">김동환</span>
                                </p>
                                <p>
                                    <span class="font_label_bold_md ml-[12px] first:m-0">사업자등록번호</span>
                                    <span class="font_label_regular_md ml-[8px]">107-87-83297</span>
                                    <span class="font_label_bold_md ml-[12px] first:m-0">통신판매업 신고번호</span>
                                    <span class="font_label_regular_md ml-[8px]">2023-서울서초-2114호</span>
                                    <span class="font_label_bold_md ml-[12px] first:m-0">대표번호</span>
                                    <span class="font_label_regular_md ml-[8px]">02-6080-0760</span>
                                    <span class="font_label_bold_md ml-[12px] first:m-0">메일</span>
                                    <span class="font_label_regular_md ml-[8px]">support_steadio@backpac.kr</span>
                                </p>
                            </div>
                            <div class="mt-[20px] flex items-center justify-between">
                                <p class="content_tertiary font_label_regular_lg">© 2024 Backpackr Inc.</p>
                                <div class="flex">
                                    <a class="ml-[20px] first:m-0" target="_blank" href="https://pf.kakao.com/_Kzxamb">
                                        <svg
                                            viewBox="0 0 17 16"
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="w-[24px] h-[24px] content_secondary"
                                        >
                                            <path
                                                fill-rule="evenodd"
                                                clip-rule="evenodd"
                    ...
                    <div class="lg:hidden">
                        <div class="px-[16px] pt-[32px] pb-[24px]">
                            <svg
                                viewBox="0 0 115 16"
                                xmlns="http://www.w3.org/2000/svg"
                                class="content_secondary h-[16px] w-[114px]"
                            >
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
                            ...
                            <div class="mt-[24px] flex flex-wrap gap-x-[16px] gap-y-[12px]">
                                <a class="false content_tertiary font_label_regular_lg" target="_blank" href="/start">
                                    크리에이터 시작
                                </a>
                                <a class="false content_tertiary font_label_regular_lg" target="_blank" href="/plans">
                                    요금제
                                </a>
                                <a
                                    class="false content_tertiary font_label_regular_lg"
                                    target="_blank"
                                    href="https://static.steadio.co/static/docs/steadio_intro.pdf"
                                >
                                    서비스 소개
                                ...
                                <a
                                    class="font-bold content_tertiary font_label_regular_lg"
                                    target="_blank"
                                    href="https://steadio.zendesk.com/hc/ko/articles/6674965622809"
                                >
                                    개인정보 처리방침
                            ...
                            <div class="content_secondary border_primary mt-[16px] border-b pb-[16px]">
                                <h5 class="font_label_bold_xl">고객지원</h5>
                                <p class="font_label_regular_lg mt-[8px]">평일 10:00~17:00 (13:00~15:00 제외)</p>
                                <a
                                    class="mt-[8px] block"
                                    target="_blank"
                                    href="https://steadio.zendesk.com/hc/ko/requests/new"
                            ...
                            <div class="content_quaternary mt-[16px] leading-none">
                                <span class="font_label_bold_sm">회사명 </span>
                                <span class="font_label_regular_sm">주식회사 백패커 </span>
                                <span class="font_label_bold_sm">주소 </span>
                                <span class="font_label_regular_sm">
                                    주소 서울특별시 서초구 서초대로 398, 20층(서초동, BNK디지털타워){' '}
                                </span>
                                <span class="font_label_bold_sm">대표 </span>
                                <span class="font_label_regular_sm">김동환 </span>
                                <span class="font_label_bold_sm">사업자등록번호 </span>
                                <span class="font_label_regular_sm">107-87-83297 </span>
                                <span class="font_label_bold_sm">통신판매업 신고번호 </span>
                                <span class="font_label_regular_sm">2023-서울서초-2114호 </span>
                                <span class="font_label_bold_sm">대표번호 </span>
                                <span class="font_label_regular_sm">02-6080-0760 </span>
                                <span class="font_label_bold_sm">메일 </span>
                                <span class="font_label_regular_sm">support_steadio@backpac.kr </span>
                            </div>
                            <p class="content_tertiary font_label_regular_md mt-[8px]">© 2024 Backpackr Inc.</p>
                            <div class="mt-[16px] flex">
                                ...
                                <a class="ml-[20px] first:m-0" target="_blank" href="https://twitter.com/steadio_co">
                                    <svg
                                        viewBox="0 0 24 24"
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="w-[24px] h-[24px] content_secondary"
