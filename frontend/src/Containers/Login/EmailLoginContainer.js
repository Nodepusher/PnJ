...
const KakaoButton = React.lazy(() => import('../../Components/Button/KakaoButton'));
const EmailButton = React.lazy(() => import('../../Components/Button/EmailButton'));
        ...
        <CommonSectionContainer text={'로그인'}>
            <div className="w-full">
                ...
                <div className="mt-[28px] flex items-center justify-between">
                    ...
                    <p className="content_secondary font_body_regular_md mx-[23px] lg:mx-[18px]">계정이 없으신가요?</p>
                    <hr className="border_primary max-w-[96px] flex-shrink flex-grow" />
                </div>
                <div className="mt-[20px] flex flex-col gap-y-[12px]">
                    <Suspense fallback={<div>Loading...</div>}>
                        <KakaoButton text="카카오로 시작하기" />
                        <EmailButton onClickNav={toVerifyPhonePage} text="이메일로 시작하기" />
                    </Suspense>
                </div>
                <div className="mt-[20px] flex items-center justify-center">
                    <p className="content_secondary font_body_regular_md mr-[8px]">비밀번호를 잊으셨나요?</p>
                    <a className="content_accent font_label_bold_lg" href="/login/find-password">
                        비밀번호 찾기
                    </a>
                </div>
            </div>
