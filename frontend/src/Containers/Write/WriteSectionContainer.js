...
const WriteSectionContainer = ({ editorRef, handleChange }) => {
    const [modalOn, setModalOn] = useState(false)

    return (
        <main class="mt-[32px]">
            <div class="editor mx-auto grid w-desktop-grid grid-cols-15 gap-x-[16px] gap-y-0">
                <WriteEditorContainer editorRef={editorRef} handleChange={handleChange}/>
                <WriteAsideContainer setModalOn={setModalOn} handleChange={handleChange} />
            </div>
