...
const WriteSectionContainer = ({ editorRef, selectedFiles, setSelectedFiles}) => {
    ...
    return (
        <main class="mt-[32px]">
            <div class="editor mx-auto grid w-desktop-grid grid-cols-15 gap-x-[16px] gap-y-0">
                ...
                <WriteAsideContainer setModalOn={setModalOn} selectedFiles={selectedFiles} setSelectedFiles={setSelectedFiles} />
            </div>
