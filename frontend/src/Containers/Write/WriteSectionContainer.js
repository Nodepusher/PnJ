...
const WriteSectionContainer = ({ editorRef, selectedFiles, setSelectedFiles, setIsSaved, isSaved }) => {
    ...
    return (
        ...
        >
            <div className="content_primary_inverse font_label_bold_lg text-left">
                <div className="flex">
                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-[20px] w-[20px]">
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                    ...
                    <span className="ml-[6px]">{updateState ? '수정 성공' : '수정 실패'}</span>
                </div>
            </div>
        </div>
    );
