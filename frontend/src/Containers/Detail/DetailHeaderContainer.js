...
const DetailHeaderContainer = () => {
    ...
    return (
        <div className="sticky top-0 left-0 z-20 h-[56px] w-full shadow-[0px_0px_4px_rgba(0,0,0,0.6)]">
            <nav
                className="sticky top-0 left-0 surface_primary z-20 flex h-[56px] w-full shrink-0 
      items-center justify-between px-[16px] lg:h-[58px] lg:px-[32px]"
            >
                <div>
                    <div className="flex items-center">
                        <a href="/">
                            <svg
                                ...
                                className="content_primary w-[31px] lg:hidden"
                            >
                            ...
                            <svg
                                viewBox="0 0 115 16"
                                xmlns="http://www.w3.org/2000/svg"
                                className="content_primary hidden w-[96px] lg:block"
                            >
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
