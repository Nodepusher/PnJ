  ...
  return (
    <>
      <div class="flex h-screen flex-col">
        <nav class="sticky top-0 left-0 surface_primary_inverse z-20 flex h-[56px] w-full shrink-0 items-center justify-between px-[16px] lg:h-[58px] lg:px-[32px]">
          <div>
            <div class="flex items-center">
              <a href="/">
                <svg
                  ...
                  class="content_primary_inverse w-[31px] lg:hidden"
                >
                ...
                <svg
                  viewBox="0 0 115 16"
                  xmlns="http://www.w3.org/2000/svg"
                  class="content_primary_inverse hidden w-[96px] lg:block"
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
              ...
              <div class="content_primary_inverse font_body_regular_md mx-[10px]">
                |
              </div>
              <div class="content_primary_inverse font_body_regular_lg flex items-center">
          ...
          <div class="flex items-center justify-end">
            <div class="relative">
              <button class="surface_primary_active relative h-[32px] w-[32px] rounded-full">
                <img
                  alt="프로필 이미지"
                  sizes="10vw"
                  srcset="
            ...
            "
                  ...
                  decoding="async"
                  data-nimg="fill"
                  class="rounded-full profile_image_2"
                  loading="lazy"
                />
              </button>
            </div>
        ...
        <div class="flex h-full overflow-hidden">
          <nav class="surface_secondary border_primary relative basis-[260px] border">
            <div class="border_disabled mx-[32px] border-b pt-[40px] pb-[28px]">
              <div class="flex flex-col items-center">
                <div class="mb-[12px]">
                  <button
                    aria-label="profile image"
                    class="relative flex h-full w-full items-center justify-center rounded-full profile_image_button"
                    type="button"
                  >
                    <img
                      alt="프로필 이미지"
                ...
                "
                      ...
                      decoding="async"
                      data-nimg="fill"
                      class="rounded-full profile_image"
                      loading="lazy"
                    />
                    <div class="border_black_opacity absolute top-0 left-0 h-full w-full rounded-full border"></div>
                  </button>
                </div>
                <h2 class="content_primary font_title_bold_md mb-[12px] text-center">
                  황자현
                </h2>
                <a target="_blank" href="/creator/code">
                  <button
                    aria-label="button"
                    class="font_button_bold_md relative flex items-center justify-center h-[32px] rounded-[16px] content_secondary surface_primary border border-solid border_black_opacity hover:surface_tertiary hover:border_secondary active:surface_tertiary active:border_secondary disabled:surface_primary disabled:border_black_opacity disabled:border disabled:border-solid px-[15px] false disabled:content_disabled"
                    type="button"
                  >
            ...
            <ul class="px-[24px] py-[32px]">
              <li class="mb-[8px] flex h-[40px] items-center rounded-[8px] px-[12px] false hover:surface_accent_light">
                <a class="flex grow items-center" href="/creator-studio/posts">
                  <svg
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span class="font_label_bold_xl block content_secondary">
                    포스트
                  </span>
                </a>
              </li>
              ...
              <li class="mb-[8px] flex h-[40px] items-center rounded-[8px] px-[12px] false hover:surface_accent_light">
                <a class="flex grow items-center" href="/creator-studio/club">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 -3 24 24"
              ...
              <li class="mb-[8px] flex h-[40px] items-center rounded-[8px] px-[12px] surface_accent_light hover:surface_accent_light">
                <a class="flex grow items-center" href="/creator-studio/page">
                  <svg
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span class="font_label_bold_xl block content_primary">
                    내 스튜디오
                  </span>
                </a>
              </li>
              <li class="mb-[8px] flex h-[40px] items-center rounded-[8px] px-[12px] false hover:surface_accent_light">
                <a class="flex grow items-center" href="/creator-studio/info">
                  <svg
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-[24px] w-[24px] mr-[10px] content_secondary"
              ...
              <li class="mb-[8px] flex h-[40px] items-center rounded-[8px] px-[12px] hover:surface_accent_light">
                <a
                  ...
                  target="_blank"
                >
                  <div class="content_secondary font_label_bold_xl flex items-center">
                    <svg
                      viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg"
                      class="content_secondary mr-[12px] h-[24px] w-[24px]"
                    >
                  ...
                  <svg
                    viewBox="0 0 11 12"
                    xmlns="http://www.w3.org/2000/svg"
                    class="content_quaternary h-[16px] w-[16px]"
                  >
          ...
          <div class="shrink-0 grow basis-0 overflow-x-auto">
            <div class="mx-auto grid w-desktop-grid grid-cols-12 gap-x-[16px] gap-y-0 pb-[64px]">
              <div class="col-span-full">
                <div class="surface_primary sticky top-0 z-10">
                  <div class="border_black_opacity col-span-full border-b pt-[41px] pb-[26px]">
                    <div class="flex justify-between">
                      <h3 class="content_primary font_headline_bold_lg">
                        내 스튜디오
                      </h3>
                      <div class="flex">
                        <button
                          aria-label="button"
                          class="font_button_bold_md relative flex items-center justify-center h-[40px] rounded-[20px] content_secondary surface_primary border border-solid border_black_opacity hover:surface_tertiary hover:border_secondary active:surface_tertiary active:border_secondary disabled:surface_primary disabled:border_black_opacity disabled:border disabled:border-solid px-[15px] false disabled:content_disabled"
                          type="button"
                        >
                          <div class="flex items-center justify-center">
                            <div>스튜디오 샘플</div>
                ...
                <div>
                  <div class="mx-auto grid w-desktop-grid grid-cols-12 gap-x-[16px] gap-y-0 pb-[64px]">
                    <div class="col-span-3 pt-[48px] mobile:pt-[56px] pb-[20px] mobile:pb-[40px]">
                      <div class="w-[297px]">
                        <div class="mb-[7px] flex items-center">
                          <strong class="content_primary font_title_bold_md mr-[6px]">
                            프로필 사진
                          </strong>
                        </div>
                        <span class="content_secondary font_body_regular_md">
                          크리에이터를 대표하는 프로필 사진을 등록 해주세요.
                        </span>
                      </div>
                    </div>
                    <div class="col-span-7 col-start-6 mobile:pt-[56px] pb-[40px]">
                      <div class="flex">
                        <div class="relative mr-[32px] flex h-[96px] min-w-[96px] items-center justify-center">
                          <img
                            alt="프로필 이미지"
                            sizes="100vw"
                            srcset="
                        ...
                        <div class="flex flex-col">
                          <div class="mb-[14px]">
                            ...
                            >
                              ...
                              <label
                                aria-label="파일 첨부"
                                class="absolute top-0 left-0 z-[1] block block h-[100%] w-full cursor-pointer opacity-0"
                          ...
                          <p class="content_quaternary font_body_regular_md">
                    ...
                    <div class="col-span-7 col-start-6 mobile:pt-[56px] pb-[40px]">
                      <main class="py-[20px] px-[16px]">
                        <div class="font_title_bold_lg">계정 설정</div>
                        <div class="mt-[20px] mb-[12px] w-full p-[16px] text-center">
                          <div class="content_quaternary font_label_bold_md mb-[8px]">
                            이메일 아이디
                          </div>
                          <div class="font_title_bold_lg">ailak@naver.com</div>
                        </div>
                        <div class="w-full">
                          <button
                            aria-label="button"
                            class="font_button_bold_md relative flex items-center justify-center flex justify-between py-[38px] px-[31px] h-[32px] rounded-[16px] content_secondary surface_primary border border-solid border_black_opacity hover:surface_tertiary hover:border_secondary active:surface_tertiary active:border_secondary disabled:surface_primary disabled:border_black_opacity disabled:border disabled:border-solid px-[15px] w-full false disabled:content_disabled"
                            type="button"
                          >
                            <div class="text-left">
                              <div class="font_title_bold_md">연락처</div>
                              <div class="content_quaternary font_label_regular_lg mt-[4px]">
                                010-5121-3284
                              </div>
                            </div>
                            <div class="content_accent font_button_bold_md">
                              변경
                            </div>
                          </button>
                        </div>
                    ...
                    <hr class="border_secondary col-span-full w-full border-t-[1px]" />
                    <div class="col-span-3 pt-[40px] pb-[20px] mobile:pb-[40px]">
                      <div class="w-[297px]">
                        <div class="mb-[7px] flex items-center">
                          <strong class="content_primary font_title_bold_md mr-[6px]">
                            커버 사진
                    ...
                    <div class="col-span-7 col-start-6 mobile:pt-[40px] pb-[40px]">
                      <div class="surface_primary border_primary rounded-[8px] border p-[24px]">
                        <div class="relative mb-[16px] h-[196px] border border-dashed surface_secondary border_primary flex items-center justify-center">
                          <svg
                            viewBox="0 0 49 49"
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            class="h-[48px] w-[48px] rounded-[8px] border-2 border-accent_100"
                          >
                            <path
                      ...
                      <div class="w-[297px]">
                        <div class="mb-[7px] flex items-center">
                          ...
                          <svg
                            viewBox="0 0 8 8"
                            xmlns="http://www.w3.org/2000/svg"
                            class="content_negative h-[8px] w-[8px]"
                          >
                    ...
                    <div class="col-span-7 col-start-6 mobile:pt-[40px] pb-[40px]">
                      <div>
                        ...
                        <div class="font_label_regular_sm mt-[8px] flex content_quaternary">
                          <div class="ml-auto">17/50</div>
                        </div>
                      </div>
                    </div>
                    <hr class="border_secondary col-span-full w-full border-t-[1px]" />
                    ...
                    <div class="col-span-7 col-start-6 mobile:pt-[40px] pb-[40px]">
                      <div class="rounded-lg border border-[#e6e6e7] p-0">
                        <textarea
                            ...
                            <div class="tox-sidebar-wrap">
                              <div class="tox-edit-area">
                                <iframe
                                  ...
                                  srcdoc='<!DOCTYPE html><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /></head><body id="tinymce" class="mce-content-body creator-description editor" data-id="tiny-react_49165891681714579170311" aria-label="서식 있는 텍스트 영역. 도움말을 보려면 ALT-0을 누르십시오."><br></body></html>'
                                ></iframe>
                              </div>
                        ...
                        <div class="z-50 mt-[-30px] mr-3 flex justify-end p-2 text-[14px] text-[#222f3e] opacity-70">
                          0자
                        </div>
                      </div>
                      <div class="font_label_regular_sm mt-[8px] flex content_quaternary"></div>
                    </div>
                    <hr class="border_secondary col-span-full w-full border-t-[1px]" />
                    <div class="col-span-3 pt-[40px] pb-[20px] mobile:pb-[40px]">
                      <div class="w-[297px]">
                    ...
                    <div class="col-span-7 col-start-6 mobile:pt-[40px] pb-[40px]">
                      <div class="flex flex-col justify-between gap-y-[16px]">
                        <div>
                    ...
                    <div class="col-span-7 col-start-6 mobile:pt-[40px] pb-[40px]">
                      <div class="surface_secondary border_disabled rounded-[8px] border p-[32px]">
                        <div class="xl:flex">
                          <div class="mb-[22px] flex items-center gap-x-[23px] xl:mb-0 xl:mr-[32px] xl:w-[136px] xl:flex-col xl:gap-x-0">
                            <div class="surface_primary border_disabled relative flex h-[76px] w-[76px] shrink-0 items-center justify-center rounded-[8px] border xl:mb-[12px]">
                              <svg
                                viewBox="0 0 49 49"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="shrink">
                              ...
                              <span class="content_quaternary font_body_regular_sm">
                          ...
                          <div class="flex flex-grow flex-col">
                            ...
                            <div class="flex justify-end">
                              <button
                                aria-label="button"
                                class="font_button_bold_md relative flex items-center justify-center h-[32px] rounded-[16px] content_primary_inverse surface_accent hover:surface_accent_active active:surface_accent_active disabled:surface_disabled px-[16px] false disabled:content_disabled"
                                disabled=""
                                type="button"
                              >
                                링크 만들기
