...
const DetailFooterPostStats = ({ likes, commentCount, views }) => {
    return (
        <div className="flex items-center">
            <div className="flex items-center gap-[10px]">
                ...
                >
                    ...
                    <span className="content_quaternary font_label_regular_sm">{likes}</span>
                </button>
                <button
                ...
                >
                    ...
                    <span className="content_quaternary font_label_regular_sm">{commentCount}</span>
                </button>
            </div>
            <div className="flex items-center">
                <svg
                ...
                <span className="content_quaternary shrink-0 text-[12px]">{views}</span>
            </div>
        </div>
    );
};
