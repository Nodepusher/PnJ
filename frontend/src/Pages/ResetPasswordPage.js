...
const ResetPasswordPage = () => {
    ...
    const moveToLoginPage = async () => {
        if (userInfo.password === userInfo.passwordCheck) {
            const url = '/user/req-reset-password';
                ...
                <div className="w-full">
                    <div className="mt-[24px]">
                        ...
                        <div className="mt-[40px]">
                            <div>
                                <p className="content_primary font_label_bold_md mb-[8px]">새 비밀번호</p>
                                <UserInput
                                    name="password"
                                    placeholder="비밀번호 입력"
                                    type="password"
                        ...
                        <div className="mt-[24px]">
                            <div>
                                <p className="content_primary font_label_bold_md mb-[8px]">새 비밀번호 확인</p>
                                <UserInput
                                    name="passwordCheck"
                                    placeholder="비밀번호 입력"
                                    type="password"
