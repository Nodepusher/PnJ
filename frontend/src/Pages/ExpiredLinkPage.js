    ...
    return (
        <section className="relative mx-auto flex w-full max-w-[400px] flex-col justify-start">
            <div className="mt-[62px] flex flex-col items-center">
                <svg viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-[88px] w-[88px]">
                    <path
                ...
                <h1 className="content_primary font_headline_bold_lg mt-[40px] text-center">만료된 링크입니다.</h1>
